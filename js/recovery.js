...
//     restingHR, hrv, drinks, energy, soreness, stress, hasData }
...
export function dailyRecovery(date) {
  ...
  const out = {
    ...
    sleepScore,
    sleepSource,
    sleepMinutes: f.sleepMinutes ?? null,
    sleepDifficulty: j.sleepDiff ?? null,
    restingHR: f.restingHR ?? null,
    hrv: f.hrv ?? null,
  ...
  out.hasData = sleepScore != null || out.restingHR != null || out.drinks != null ||
    out.energy != null || out.soreness != null || out.stress != null;
  return out;
}
